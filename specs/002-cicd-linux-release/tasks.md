...
- [x] T001 Create workflows directory `.github/workflows/`

## Phase 2: Foundational
*Goal: Establish the workflow file structure.*

- [x] T002 Create `.github/workflows/release.yml` with tag trigger configuration
...
- [x] T003 [US1] Add checkout and Python setup steps to `.github/workflows/release.yml`
- [x] T004 [US1] Add dependency installation step (requirements.txt + dev tools) to `.github/workflows/release.yml`
- [x] T005 [US1] Add PyInstaller build step to `.github/workflows/release.yml`
- [x] T006 [US1] Add release step using `softprops/action-gh-release` to upload `dist/ddc-control`
...
- [x] T007 [US2] Add `pytest` execution step before build in `.github/workflows/release.yml`
- [x] T008 [US2] Add `ruff` linting step before build in `.github/workflows/release.yml`

## Final Phase: Polish
*Goal: Ensure configuration is correct and clean.*

- [x] T009 Verify workflow syntax and configuration
